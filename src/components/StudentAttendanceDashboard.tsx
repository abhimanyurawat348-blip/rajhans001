...
const StudentAttendanceDashboard: React.FC<{ studentId: string }> = ({ studentId }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="card-body">
          <h3 className="text-xl font-bold text-primary mb-4">Today's Attendance</h3>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                {(() => {
                  ...
                  if (todayRecord) {
                    const { icon: StatusIcon, color, bgColor } = getStatusInfo(todayRecord.status);
                    return (
                ...
                <div className="ml-4">
                  {(() => {
                    ...
                    if (todayRecord) {
                      ...
                      return (
                        <>
                          <p className="text-lg font-bold text-primary">Not Marked</p>
                          <p className="text-sm text-tertiary">
        ...
        <div className="card-body">
          ...
          <div className="mt-4">
            ...
            <div className="flex items-center mt-2">
              <Target className="h-4 w-4 text-tertiary mr-1" />
              <p className="text-sm text-tertiary">
