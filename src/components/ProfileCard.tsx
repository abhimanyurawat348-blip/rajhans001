    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
      ...
      <div className="flex items-center space-x-6 mb-6">
        {studentData.avatar ? (
          ...
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white text-2xl font-bold border-4 border-white shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex items-center space-x-3 p-3 bg-green-50 dark:bg-gray-700 rounded-lg">
        ...
        <div className="flex items-center space-x-3 p-3 bg-purple-50 dark:bg-gray-700 rounded-lg">
          <Phone className="h-5 w-5 text-purple-600 dark:text-purple-400" />
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">Phone</p>
            <p className="font-semibold text-gray-900 dark:text-white">{studentData.phone}</p>
          </div>
        </div>
      </div>
    </div>
